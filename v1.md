...
- `x_off_y` vouchers are auto-issued from active rules for both identified and anonymous customers:
...
- `x_off_y` (member or anonymous): starts tomorrow, lifetime `365` days
